            ...
            child: Column(
              children: <Widget>[
                ...
                ElevatedButton(
                  ...
                  onPressed: () async { await _launchUrl('https://www.patreon.com/MarotiDevel'); },
                  child: Text(translation('Support me on Patreon', settings[0]), style: TextStyle(color: WHITE), textScaleFactor: 1.4,)
                ),
              ],
            ),
          ),
